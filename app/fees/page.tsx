    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 max-w-5xl py-12">
        ...
        <section id="fee-index" className="mb-12">
          <Card className="border-2 border-gray-100 shadow-sm">
            <CardHeader className="bg-gray-50 border-b border-gray-100">
              <CardTitle className="text-2xl font-black text-gray-900">ファクタリング18社 手数料・入金スピード比較（公式を実確認）</CardTitle>
            </CardHeader>
            <CardContent className="pt-6">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">
                主要18社の<strong>手数料率（2社間/3社間）・最短入金・利用可能額・対象・オンライン完結</strong>を、各社公式サイトで<strong>{feeCheckedAt}に一件ずつ確認</strong>して一覧化しました。公式に手数料率を明示していない社は「非公示（要見積もり）」と正直に記載しています（改定が速い分野のため月次で再確認・更新）。
              </p>
